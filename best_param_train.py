...
my_data = genfromtxt('best_acc_hyper_param.txt', delimiter=',')
...
def train():
    ...
    model_systole = get_model(my_data[0],my_data[1],my_data[2],my_data[3])
    model_diastole = get_model(my_data[0],my_data[1],my_data[2],my_data[3])
