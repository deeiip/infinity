...
def train_accuracy(drop_out_1, drop_out_2, drop_out_3, drop_out_4):
    """
    Training systole and diastole models.
    """
    print('trying with {0}, {1}, {2}, {3}'.format(drop_out_1, drop_out_2, drop_out_3, drop_out_4))
    print('=====================================================')
    crps_train_min = 2
    crps_test_min = 2
    print('Loading and compiling models...')
    model_systole = get_model(drop_out_1, drop_out_2, drop_out_3, drop_out_4)
    model_diastole = get_model(drop_out_1, drop_out_2, drop_out_3, drop_out_4)
    ...
    for i in range(nb_iter):
        ...
        if calc_crps > 0 and i % calc_crps == 0:
            ...
            if crps_test_min > crps_test:
                crps_test_min = crps_train
